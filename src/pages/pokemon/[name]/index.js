        ...
        {pokemon ? (
          <div className='flex flex-col items-center border-2  bg-white rounded-lg w-1/4 '>
            ...
            <div className='bg-[#fdc666] rounded-lg p-6 '>
              ...
              <p className='mb-2'>
                <b>Type:</b> {pokemon.types.map((type) => type.type.name).join(', ')}
              </p>
              <p className='mb-2'>
                <b>Stats:</b> {pokemon.stats.map((stat) => stat.stat.name).join(', ')}
              </p>
              <p className='mb-2'>
                <b>Abilities:</b> {pokemon.abilities.map((ability) => ability.ability.name).join(', ')}
              </p>
              <p>
                <b>Some Moves:</b>{' '}
                {pokemon.moves
